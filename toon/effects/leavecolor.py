...
frag = """
/**
 * Fragment shader for color band pass.
 * 
...
def set_program_uniforms():
    ...
    program.glUniform3f("keying_color", config['colorpass_r'], config['colorpass_g'], config['colorpass_b'])
    program.glUniform1f("thresh", config['colorpass_thresh'])
    program.glUniform1f("slope", config['colorpass_slope'])
#     print 'color:%s %s %s, thresh:%s, slope:%s' % (config['colorpass_r'], config['colorpass_g'], config['colorpass_b'], thresh, slope)
