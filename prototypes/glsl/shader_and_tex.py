#!/usr/bin/env python
"""
Shader test using a texture as well
"""
from ctypes import *
import sys
...
# ---------- and now, the specific to using textures with shaders
import pygame.image
...
if __name__ == '__main__':
    ...
    # ------- texture loading -------
    image = pygame.image.load('colorbars.png')
    ...
    while not quit:
        ...
        #Get the location of the uniform sampler2D in Python 
        # (if it's -1, you've 
