This folder currently has a lot of work in progress files. 
The one that might be interesting are : 

 * glCamera.py : OpenGL texture of the camera feed. Toggle fullscreen.
