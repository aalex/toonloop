...
void Application::run(int argc, char *argv[])
{
    ...
    desc.add_options()
        ...
        ("video-source,d", po::value<std::string>()->default_value(video_source), "Sets the video source or device. Use \"test\" for color bars. Use \"x\" to capture the screen. Use \"dv\" for DV capture")
